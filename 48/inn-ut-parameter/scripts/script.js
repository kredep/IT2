...
var ord = ["bil", "båt", "fly", "tog", "ubåt"];

function startUp() {
    document.getElementById("oppg1").innerHTML += kvadrat(12);
    document.getElementById("oppg2").innerHTML = traverser(ord);
    document.getElementById("oppg3").innerHTML += biggest(-2,5);
    document.getElementById("nullpunkt").onclick = finnNullpunkter;
...
function finnNullpunkter() {
    var a = document.getElementById("np-a").value;
    var b = document.getElementById("np-b").value;
    if (isNaN(a) || isNaN(b)) {
        document.getElementById("oppg5").innerHTML = "a og b må være tall!";
    } else {
        document.getElementById("oppg5").innerHTML = "Nullpunktet ligger i x = " + nullpunkt(a,b);
    }
}

function nullpunkt(a,b) {
    return -b/a;
}
